...
namespace Valid.Biometric.FindFingerprintYoloTinyV4NetCore
{
    public class FindFingerprintYoloTinyV4NetCore : IDisposable
    {
        ...
        public FindFingerprintYoloTinyV4NetCore(YoloConfiguration yoloConfiguration, GpuConfig gpuConfig = null, IYoloSystemValidator yoloSystemValidator = null)
        {
        ...
        /// <exception cref="NotSupportedException">Thrown when the process not run in 64bit</exception>
        /// <exception cref="YoloInitializeException">Thrown if an error occurs during initialization</exception>
        public FindFingerprintYoloTinyV4NetCore(string configurationFilename, string weightsFilename, string namesFilename, GpuConfig gpuConfig = null, IYoloSystemValidator yoloSystemValidator = null)
        {
            if (yoloSystemValidator == null)
            {
                this._yoloSystemValidator = new DefaultYoloSystemValidator();
        ...
        private byte[] GetAndCropImage(byte[] image, IEnumerable<YoloItem> yoloItems)
        {
            ...
            var topYoloItem = yoloItems?.Where(x => x.Confidence >= 0.80).OrderByDescending(x => x.Confidence).First();
